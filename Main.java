...
class Main {
    //data buku
    public static String[] idBuku = new String[] {"12", "34", "56"};
    public static String[] namaBuku = new String[] {"judul1", "judul2", "judul3"};
    public static String[] author = new String[] {"Ana", "Ani", "Ina"};
    public static String[] category = new String[] {"Ips", "Ipa", "PBO"};
    public static int[] stock = new int[] {9, 3, 7};
